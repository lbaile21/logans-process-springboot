...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "script", name = "Script", hidden = false)
public class ScriptModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<ScriptModelOutput> {
    ...
    @Override()
    public ScriptModelOutput toModel() {
        ScriptModelOutput result = new ScriptModelOutput();
        result.setId(getId());
